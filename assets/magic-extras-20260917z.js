...
(() => {
  ...
  async function renderChatTab(panel) {
    ...
    panel.innerHTML = `
      ...
      <p>Assistente AI per il tuo viaggio: fai domande, chiedi idee, confronti e consigli. Può proporti tappe da aggiungere all’itinerario.</p>
      <div class="pv-chips" id="pv-chat-chips">
        ...
        <button type="button" data-q="Consigli pratici per il viaggio (soldi, clima, trasporti)">Consigli pratici</button>
        <button type="button" data-q="Frasi utili e come comportarsi con la gente del posto">Lingua e usi</button>
      </div>
